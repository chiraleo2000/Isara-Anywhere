// Complete SVG Icon Components for Izara Anywhere
...
export const HealthCenterIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const PhoneIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.515l.72 2.882a2 2 0 01-.45 1.705l-1.27 1.27a16.001 16.001 0 006.364 6.364l1.27-1.27a2 2 0 011.705-.45l2.882.72A2 2 0 0121 18.72V21a2 2 0 01-2 2h-.01C9.61 23 1 14.39 1 3.01V3a2 2 0 012-2z"
    />
  </svg>
);

// Additional Icons for New Navigation
...
export const CalendarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 2v4m12-4v4M4 8h16M4 8a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V10a2 2 0 00-2-2M4 8h16" />
  </svg>
);
