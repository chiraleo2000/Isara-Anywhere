...
import { resolveEnv, resolveEnvBool } from '../utils/resolveEnv';
...
export const config = {
  ...
  gcp: {
    projectId: resolveEnv('GCP_PROJECT_ID', 'izara-telemedicine'),
    region: resolveEnv('GCP_REGION', 'asia-southeast1') || import.meta.env.VITE_GCP_REGION || 'asia-southeast1',
  },
  ...
  gemini: {
    ...
    model: resolveEnv('GEMINI_MODEL', 'gemini-3.1-flash-lite'),
  ...
  features: {
    // PDPA Compliance
    pdpaEnabled: resolveEnvBool('PDPA_ENABLED') || import.meta.env.VITE_PDPA_ENABLED === 'true',
    consentRequired: resolveEnvBool('CONSENT_REQUIRED') || import.meta.env.VITE_CONSENT_REQUIRED === 'true',
