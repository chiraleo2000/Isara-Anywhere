...
// Status badge class mapping to avoid nested ternaries (SonarQube S3358)
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getAppointmentStatusClass(apt.status)}`}>
