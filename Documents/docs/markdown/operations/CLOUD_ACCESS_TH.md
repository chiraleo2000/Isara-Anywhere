...
> อัปเดต: 22 มิถุนายน 2569 | Environment: Google Cloud Run (asia-southeast1) | Project: izara-telemedicine  
> **Release track:** v1.7.53 · Gates: unit **~3200**, phase **0–9**, `test:local:pre-deploy-gate`, LAN Mode B docs in `deploy/nginx/`
