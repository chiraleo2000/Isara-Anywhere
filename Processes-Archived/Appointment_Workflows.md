...
**Last Updated: January 19, 2026 (v2.0.0 - Phase 1: PostgreSQL + AI Enhancements)**

---

## 🆕 Phase 1 Updates (January 2026)
...
| **Real-time Transcription** | 🚧 | Web Speech API for free transcription |
...
|------|-------|----------|-------------|
| Patient | Somchai.Mankong@gmail.com | P@ssw0rd | New patient with hypertension |
| Patient | Anan.Khayanrian@gmail.com | P@ssw0rd | Complex case: DM + CKD Stage 3b |
| Admin | admin.test@izara.com | IzaraAdmin@2024 | Full system access |
| Doctor | doctor.test@izara.com | IzaraDoctor@2024 | Clinical workflows |
