...
ผู้ป่วยสามารถเชิญ **ญาติ เพื่อน หรือบุคคลภายนอก** เข้าร่วมประชุมได้ โดยผู้ถูกเชิญ **ไม่ต้องมีบัญชี** เพียงกรอกชื่อแล้วรอแพทย์อนุมัติ

**วิธีเข้าร่วมสำหรับแขก (Guest):**

1. **รับลิงก์เชิญ** จากผู้ป่วย เช่น `https://patient-portal/guest-join/meeting-id`
2. **กรอกชื่อ** ในหน้า Guest Join (ไม่ต้องล็อกอิน ไม่ต้องมีอีเมล)
3. **กด "ขอเข้าร่วม"** → ระบบแจ้งแพทย์ทันที
4. **รอแพทย์อนุมัติ** — เห็นหน้าจอ "รอการอนุมัติ" พร้อมตัวนับเวลา
5. **เข้าห้องประชุม** — เมื่อแพทย์กด "อนุญาต" จะเข้าสู่วิดีโอคอลทันที

**สำหรับแพทย์ (Host):**

- เห็น **Waiting Room** พร้อมรายชื่อผู้รอ
...
**ขั้นที่ 3:** เข้าร่วมในฐานะ **HOST** (ผู้ดำเนินรายการ — คล้าย Microsoft Teams)

- อนุมัติผู้ป่วย แขก และ Admin จาก **Waiting Room** (Lobby)
  - กดปุ่ม **✓ อนุญาต** หรือ **✗ ปฏิเสธ** สำหรับแต่ละคน
  - แขกกรอกชื่อเข้า `/guest-join/:meetingId` โดยไม่ต้องมีบัญชี
