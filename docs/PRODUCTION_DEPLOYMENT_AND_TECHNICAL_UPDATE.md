...
| Output | Typography |
|--------|------------|
| `docs/USER_GUIDE_*_WORD_TH.docx` | **TH Sarabun New** — body **16 pt**, H1 **18 pt**, title **22 pt**, line spacing **1.15** |
| `docs/USER_GUIDE_*_PPT_TH.pptx` | **FC Iconic** — title **32 pt**, body **18 pt**, speaker notes **16 pt** |
...
- `docs/USER_GUIDE_DOCTOR_WORD_TH.docx` / `docs/USER_GUIDE_DOCTOR_PPT_TH.pptx` (Sarabun 16 pt / FC Iconic)
- `docs/USER_GUIDE_PATIENT_WORD_TH.docx` / `docs/USER_GUIDE_PATIENT_PPT_TH.pptx`
