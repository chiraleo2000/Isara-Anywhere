...
**Latest proof (2026-07-16):** local + cloud hard gates green — [LOCAL_GREEN_CHECKPOINT.md](../../reports/LOCAL_GREEN_CHECKPOINT.md), [CLOUD_GREEN_CHECKPOINT.md](../../reports/CLOUD_GREEN_CHECKPOINT.md); cloud UI showup A/B/C **15 passed**; full coverage **zero residuals**; published PNGs in [`docs/screenshots/`](../screenshots/); cloud purge blocked on `CLOUD_DB_PASSWORD` — see [CLOUD_ACCESS_TH.md](../../Documents/docs/markdown/operations/CLOUD_ACCESS_TH.md).
