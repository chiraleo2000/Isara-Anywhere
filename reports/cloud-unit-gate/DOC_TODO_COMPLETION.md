...
| Word TH Sarabun New 16 pt | `docs/USER_GUIDE_*_WORD_TH.docx`, `TECHNICAL_ARCHITECTURE_WORD_TH.docx` |
| PPT FC Iconic | `docs/USER_GUIDE_*_PPT_TH.pptx`, `TECHNICAL_ARCHITECTURE_PPT_TH.pptx` |
