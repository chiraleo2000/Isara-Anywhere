...
export const HIGH_LEVEL_WORKFLOW_TESTS: ProcessWorkflowEntry[] = [
  ...
  { processDoc: 'Processes/Clinical_Document_Delivery_Workflows.md', domain: 'Clinical', priority: 'P0', unitTests: ['cross-portal/clinicalDocumentDelivery.test.ts', 'patient-portal/phrDocuments.test.ts', 'cross-portal/emrToPhrDelivery.integration.test.ts', 'cross-portal/pageElementContract.test.ts'] },
  ...
  { processDoc: 'Processes/GATE0_IMPLEMENTATION_STATUS.md', domain: 'Appointments', priority: 'P0', unitTests: ['cross-portal/gate0ImplementationContract.test.ts', 'doctor-portal/queueLifecycle.integration.test.ts', 'cross-portal/appointmentWorkflowContract.test.ts'] },
