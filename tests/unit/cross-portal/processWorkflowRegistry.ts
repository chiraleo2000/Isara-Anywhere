...
export const DOCTOR_PORTAL_PROCESS_TESTS: ProcessWorkflowEntry[] = [
  ...
  { processDoc: 'Processes/Pages/Doctor-Portal/06_Health_Meeting_Page.md', domain: 'Meeting', priority: 'P0', unitTests: ['doctor-portal/meetingJoinContract.test.ts', 'doctor-portal/meetingWorkflowHardening.test.ts', 'doctor-portal/queueAcceptTraceability.test.ts', 'doctor-portal/clinicalBreadcrumb.test.ts', 'cross-portal/defectIsaraPdfMeetingQueue.test.ts', 'cross-portal/appointmentUxContract.test.ts'] },
  { processDoc: 'Processes/Pages/Doctor-Portal/07_Virtual_Meeting.md', domain: 'Meeting', priority: 'P0', unitTests: ['doctor-portal/meetingWorkflowHardening.test.ts', 'doctor-portal/meetingTimeService.test.ts', 'doctor-portal/meetingRoomRoutes.test.ts', 'cross-portal/meetingUxContract.test.ts'] },
  { processDoc: 'Processes/Pages/Doctor-Portal/08_EMR_Editor.md', domain: 'Clinical', priority: 'P1', unitTests: ['doctor-portal/emrService.test.ts', 'doctor-portal/emrAutosave.test.ts', 'doctor-portal/emr-clinical.test.ts', 'doctor-portal/emrAiDraft.test.ts', 'cross-portal/phrEmrUxContract.test.ts'] },
...
export const PATIENT_PORTAL_PROCESS_TESTS: ProcessWorkflowEntry[] = [
  ...
  { processDoc: 'Processes/Pages/Patient-Portal/06_PHR_Page.md', domain: 'Clinical', priority: 'P0', unitTests: ['patient-portal/phrRoute.test.ts', 'patient-portal/sharedPHRTypes.test.ts', 'patient-portal/phrTimeline.route.test.ts', 'patient-portal/phrDocuments.test.ts', 'cross-portal/healthRecordsWorkflowContract.test.ts', 'cross-portal/phrEmrUxContract.test.ts'] },
  ...
  { processDoc: 'Processes/Pages/Patient-Portal/11_Living_Will_Page.md', domain: 'Clinical', priority: 'P2', unitTests: ['patient-portal/livingWillWorkflow.test.ts', 'patient-portal/livingWillInput.behavior.test.ts', 'patient-portal/livingWillCanonicalPath.regression.test.ts', 'cross-portal/livingWillContract.test.ts'] },
  ...
  { processDoc: 'Processes/Pages/Patient-Portal/15_Notification_System.md', domain: 'Notifications', priority: 'P2', unitTests: ['patient-portal/notificationWorkflow.test.ts', 'patient-portal/notificationService.test.ts', 'patient-portal/notificationsRoute.test.ts', 'cross-portal/notificationWorkflowContract.test.ts'] },
];
...
export const MEETING_SERVER_PROCESS_TESTS: ProcessWorkflowEntry[] = [
  ...
  { processDoc: 'Processes/Pages/Meeting-Server/01_Meeting_Room.md', domain: 'Meeting', priority: 'P0', unitTests: ['meeting-server/joinConfigAcceptance.test.ts', 'cross-portal/jitsiMeetingConfig.test.ts', 'cross-portal/meetingUxContract.test.ts'] },
  { processDoc: 'Processes/Pages/Meeting-Server/02_Meeting_Results.md', domain: 'Meeting', priority: 'P0', unitTests: ['doctor-portal/meetingResultsValidation.test.ts', 'cross-portal/postMeetingWorkflow.integration.test.ts', 'cross-portal/meetingUxContract.test.ts'] },
  { processDoc: 'Processes/Pages/Meeting-Server/03_Emr_Appointment_Page.md', domain: 'Clinical', priority: 'P0', unitTests: ['doctor-portal/emrAiDraft.test.ts', 'doctor-portal/meetingRoomRoutes.test.ts', 'cross-portal/phrEmrUxContract.test.ts'] },
];

export const HIGH_LEVEL_WORKFLOW_TESTS: ProcessWorkflowEntry[] = [
  { processDoc: 'Processes/Appointment_Workflows.md', domain: 'Appointments', priority: 'P0', unitTests: ['cross-portal/appointmentWorkflowContract.test.ts', 'cross-portal/calendarConfirmNotification.test.ts', 'cross-portal/appointmentUxContract.test.ts', 'doctor-portal/queueLifecycle.integration.test.ts', 'doctor-portal/confirmSetsConfirmedDate.test.ts', 'patient-portal/unifiedQueueFilter.test.ts', 'patient-portal/appointmentWorkflow.test.ts'] },
  ...
  { processDoc: 'Processes/POST_MEETING_WORKFLOW.md', domain: 'Meeting', priority: 'P0', unitTests: ['cross-portal/postMeetingWorkflow.integration.test.ts', 'cross-portal/meetingLifecycleFixture.test.ts', 'meeting/parseLobbyThreeParty.test.ts', 'meeting-server/generateSummary.integration.test.ts', 'meeting-server/recordingRoundTrip.integration.test.ts', 'meeting-server/meetingSmokeStepsContract.test.ts', 'doctor-portal/meetingResultsValidation.test.ts'] },
  { processDoc: 'Processes/VIDEO_MEETING_JITSI_GEMINI.md', domain: 'Meeting', priority: 'P0', unitTests: ['meeting-server/jitsiRoleJwt.test.ts', 'meeting-server/threePartyLobby.integration.test.ts', 'meeting-server/portalCorsOrigins.test.ts', 'cross-portal/jitsiMeetingConfig.test.ts', 'cross-portal/resolveMeetingEnv.test.ts', 'cross-portal/meetingBffProxyContract.test.ts', 'cross-portal/sessionAuthCrossPortal.test.ts', 'patient-portal/jitsiDisplayName.behavior.test.ts', 'patient-portal/meetingJoinProxy.test.ts', 'doctor-portal/meetingWorkflowHardening.test.ts', 'doctor-portal/meetingRecordingUi.test.ts', 'meeting/parseLobbyThreeParty.test.ts'] },
  { processDoc: 'Processes/Notification_Workflows.md', domain: 'Notifications', priority: 'P2', unitTests: ['patient-portal/notificationWorkflow.test.ts', 'patient-portal/notificationService.test.ts', 'cross-portal/notificationWorkflowContract.test.ts'] },
  { processDoc: 'Processes/Combined_Workflows_And_Actions.md', domain: 'Workflows', priority: 'P0', unitTests: ['cross-portal/combinedWorkflowActions.test.ts', 'cross-portal/fullWorkflowInvariants.test.ts'] },
  ...
  { processDoc: 'Processes/Living_Will_Processes.md', domain: 'Clinical', priority: 'P2', unitTests: ['cross-portal/livingWillContract.test.ts', 'patient-portal/livingWillWorkflow.test.ts'] },
  { processDoc: 'Processes/Data_Sync_Documentation.md', domain: 'Sync', priority: 'P1', unitTests: ['cross-portal/syncQueue.integration.test.ts', 'doctor-portal/queueSocket.test.ts', 'cross-portal/dataSyncValidation.test.ts'] },
  { processDoc: 'Processes/ENV_AND_STACK_CHECK.md', domain: 'Infrastructure', priority: 'P0', unitTests: ['cross-portal/doctorEnvAudit.test.ts', 'config/envSchema.test.ts'] },
  ...
  { processDoc: 'Processes/User_management_Workflows.md', domain: 'Auth', priority: 'P1', unitTests: ['doctor-portal/adminDoctorManagement.test.ts', 'patient-portal/userManagementWorkflow.test.ts', 'patient-portal/registerRoute.test.ts'] },
  { processDoc: 'Processes/Clinical_Resources_&_Medical_Library_Workflows.md', domain: 'Content', priority: 'P2', unitTests: ['doctor-portal/clinicalResources.test.ts', 'patient-portal/contentRoute.test.ts'] },
  ...
  { processDoc: 'Processes/Medicine_Content_Processes.md', domain: 'Content', priority: 'P2', unitTests: ['doctor-portal/medicalContentWorkflow.test.ts', 'patient-portal/medicalContentThumbnail.behavior.test.ts'] },
