...
describe('Admin nav badges', () => {
  ...
  it('BADGE-06 — ResponsiveLayout wires testids for manual verification', () => {
    const layout = fs.readFileSync(
      path.resolve(__dirname, '../../../Isara-doctor-portal/frontend/components/common/ResponsiveLayout.tsx'),
      'utf8',
    );
    expect(layout).toMatch(/function getNavBadgeCount/);
    expect(layout).toMatch(/useAdminNavBadges/);
