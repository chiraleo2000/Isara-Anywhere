...
describe('notificationDedupContract — source', () => {
  it('NDD-SRC — notification types and deep-link targets exist', () => {
    const bell = fs.readFileSync(
      path.join(root, 'issara-patient/frontend/components/notifications/NotificationBell.tsx'),
      'utf8',
    );
    ...
    const docs = fs.readFileSync(
      path.join(root, 'issara-patient/docs/pages/15_Notification_System.md'),
      'utf8',
    );
