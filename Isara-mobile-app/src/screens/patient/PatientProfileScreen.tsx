  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.scroll}>
        ...
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('PDPAConsent', { patientId: user?.id ?? '' })}>
          <Text style={styles.menuIcon}>🔒</Text>
          <Text style={styles.menuText}>Privacy & Consent</Text>
          <Text style={styles.menuArrow}>›</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('AIAssistant')}>
          <Text style={styles.menuIcon}>🤖</Text>
          <Text style={styles.menuText}>AI Health Assistant</Text>
          <Text style={styles.menuArrow}>›</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#1e40af', alignItems: 'center', padding: 24, paddingBottom: 28 },
  ...
  email: { fontSize: 14, color: '#bfdbfe', marginTop: 2 },
