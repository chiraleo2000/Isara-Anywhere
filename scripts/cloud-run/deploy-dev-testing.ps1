...
Write-Host "  IZARA TELEMEDICINE v1.4.7 — Cloud Run Dev-Testing Deployment" -ForegroundColor Magenta
...
if (-not $SkipBuild) {
    ...
    docker build -f Dockerfile.unified `
        ...
        --build-arg VITE_APP_VERSION="1.4.7-dev" `
...
Write-Host "  DEPLOYMENT COMPLETE — Izara Telemedicine v1.4.7 Dev-Testing" -ForegroundColor Green
Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Green
