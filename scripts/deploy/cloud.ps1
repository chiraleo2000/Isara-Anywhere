...
Write-Host "  IZARA TELEMEDICINE v2.0.0 — Cloud Run Deployment" -ForegroundColor Magenta
...
if (-not $SkipBuild) {
    ...
    docker build -f Dockerfile.unified `
        ...
        --build-arg VITE_APP_VERSION="2.0.0-dev" --build-arg VITE_APP_ENV=production `
