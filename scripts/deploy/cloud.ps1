...
Write-Host "  IZARA TELEMEDICINE v1.6.0 — Cloud Run Deployment" -ForegroundColor Magenta
...
Write-Host "  DEPLOYMENT COMPLETE — Izara Telemedicine v1.6.0 Dev-Testing" -ForegroundColor Green
