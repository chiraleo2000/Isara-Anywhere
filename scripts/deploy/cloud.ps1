...
Write-Host "  IZARA TELEMEDICINE v1.5.9 — Cloud Run Deployment" -ForegroundColor Magenta
...
if (-not $SkipBuild) {
    ...
    docker build -f Dockerfile.unified `
        ...
        --build-arg VITE_APP_VERSION="1.5.9" --build-arg VITE_APP_ENV=production `
...
Write-Host "  DEPLOYMENT COMPLETE — Izara Telemedicine v1.5.9 Dev-Testing" -ForegroundColor Green
