...
SLIDES: list[dict] = [
    ...
    },
    {
        ...
        "body": [
            "แผนภาพ: docs/diagrams/diagrams.drawio (export PNG/PDF จาก draw.io)",
    ...
    },
    {
        ...
        "notes": "README.md, docs/markdown/operations/CLOUD_ACCESS_TH.md, docs/diagrams/diagrams.drawio",
    },
]
