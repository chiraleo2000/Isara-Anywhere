> **SSOT header** - Canonical source: `Processes/POST_MEETING_WORKFLOW.md` (Isara-Anywhere platform).
> **App copy:** `Izara-jitsi-server/docs/workflows/POST_MEETING_WORKFLOW.md` | **Primary workflow** for STREAM-MEETING
