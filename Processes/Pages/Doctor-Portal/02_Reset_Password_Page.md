...
|-------|-------|
| **Status** | covered |
| **Unit tests** | `authServer.http.test.ts` |
| **UI (Playwright)** | Group A |
...
**Matrix row:** `02_Reset_Password_Page` in [tests/PROCESS_COVERAGE_MATRIX.md](../../tests/PROCESS_COVERAGE_MATRIX.md)
