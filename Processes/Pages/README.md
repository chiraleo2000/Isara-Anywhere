...
คู่มือผู้ใช้: `docs/guides/patient|doctor/USER_GUIDE_*_WORD_TH.docx` · `docs/guides/patient|doctor/USER_GUIDE_*_PPT_TH.pptx` — `python scripts/build-portal-user-guides.py`

โครงสร้างเทคนิค: `docs/technical/word/TECHNICAL_ARCHITECTURE_WORD_TH.docx` · `docs/technical/ppt/TECHNICAL_ARCHITECTURE_PPT_TH.pptx` · `docs/diagrams/diagrams.drawio` · `docs/technical/slides/TECHNICAL_ARCHITECTURE_SLIDES.html` — `npm run guides:technical`
