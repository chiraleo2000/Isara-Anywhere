...
> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Separated_Workflows_And_Functions.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Separated_Workflows_And_Functions.md`](../Separated_Workflows_And_Functions.md)  
...
- [B. นัดหมาย Workflow](#b-นัดหมาย-workflow)


- [C. ประชุมวิดีโอ Workflow](#c-video-meeting-workflow)
...
- [F. ใบสั่งยา Workflow](#f-ใบสั่งยา-workflow)


- [G. คำสั่งตรวจแล็บ Workflow](#g-lab-orders-workflow)


- [H. PHR Management Workflow](#h-phr-management-workflow)


- [I. หนังสือแสดงเจตจำนอง Workflow](#i-living-will-workflow)
...
- [O. แพทย์ Registration & Approval Workflow](#o-แพทย์-registration--approval-workflow)


- [P. Queue Management Workflow](#p-queue-management-workflow)


- [Q. AI Health Chat (ผู้ป่วย)](#q-ai-health-chat-ผู้ป่วย)


- [R. AI Studio (แพทย์)](#r-ai-studio-แพทย์)
...
- 2-ขั้นตอน wizard with progress indicator
...
**Pages:** `LoginPage.tsx` (พอร์ทัลแพทย์)
**API:** `POST /api/auth/login`
**Tables:** `users`, `sessions`
...
- Same login flow as ผู้ป่วย


- Approval gate (ผู้ดูแลระบบ must approve first)


- Role-based redirect (แพทย์ dashboard vs ผู้ดูแลระบบ dashboard)
...
## B. Appointment ขั้นตอนการทำงาน


### B1. Patient Booking

**Pages:** `AppointmentPages.tsx` → จองนัด นัดหมาย
...
- Multi-ขั้นตอน booking wizard


- AI-assisted symptom analysis


- แพทย์ selection (optional — can be pool)
...
- AI specialty-to-แพทย์ matching
...
- Stats dashboard (รอดำเนินการ/assigned/total)
...
## C. Video Meeting ขั้นตอนการทำงาน
...
- แพทย์ as HOST (mute/kick/lobby control)


- Lobby mode (ผู้ป่วย waits for admission)
...
**Pages:** นัดหมาย Detail → Join button
**Flow:** ผู้ป่วย click → Jitsi lobby → แพทย์ admits
...
**API:** Internal (พอร์ทัลแพทย์ backend)
...
## E. EMR Documentation ขั้นตอนการทำงาน
...
- Man-in-the-Loop (แพทย์ตรวจสอบก่อนส่งถึงผู้ป่วย) validation
...
## F. Prescriptions ขั้นตอนการทำงาน
...
## H. PHR Management ขั้นตอนการทำงาน
...
## J. PDPA Consent ขั้นตอนการทำงาน
...
## K. Content Management ขั้นตอนการทำงาน
...
**Pages:** `MedicalContent.tsx` (ผู้ดูแลระบบ view)
...
## L. Clinical Resources ขั้นตอนการทำงาน
...
## M. Medical Consultants ขั้นตอนการทำงาน
...
## N. Notification ขั้นตอนการทำงาน
...
## O. Doctor Registration & Approval ขั้นตอนการทำงาน


### O1. Doctor Registration

**Pages:** LoginPage.tsx (พอร์ทัลแพทย์) → Register tab
**API:** `POST /api/auth/register`
**Tables:** `users`
...
## P. Queue Management ขั้นตอนการทำงาน
...
| นัดหมาย | §4 (Pipeline) | B1-B4 | 05_Appointments_Page.md, 17_Admin_Appointment_Management.md |
...
| ใบสั่งยา | §8 (Clinical Actions) | F1 | 09_Prescribing.md |
| คำสั่งตรวจแล็บ | §8 (Clinical Actions) | G1 | 10_Lab_Orders.md |
| PHR | §8 (PHR Actions) | H1-H3 | 06_PHR_Page.md |
| หนังสือแสดงเจตจำนอง | §8 (PHR Actions) | I1-I2 | 11_Living_Will_Page.md |
...
| Consultants | §8 (ผู้ดูแลระบบ Actions) | M1-M2 | 12_Medical_Consultants_Page.md |
| การแจ้งเตือน | §9 (Notification Flow) | N1 | 15_Notification_System.md |
| แพทย์ Mgmt | §3 (ผู้ดูแลระบบ Workflow) | O1-O3 | 18_Admin_Doctor_Management.md |
| Queue | §2 (แพทย์ Workflow) | P1 | 21_Queue_Management.md |
| AI Chat (ผู้ป่วย) | §1 (Ongoing Care) | Q1 | 07_AI_Doctor_Page.md |
| AI Studio (แพทย์) | §2 (Between Consults) | R1 | 15_Gemini_AI_Studio.md |
...
| นัดหมาย | `appointments`, `doctor_schedules`, `appointment_ai_suggestions` |
...
| หลังประชุม | `patient_instructions`, `health_timeline`, `follow_ups` |
