# พอร์ทัลผู้ป่วย — PHR Page (Personal Health Records)

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Patient-Portal/06_PHR_Page.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Patient-Portal/06_PHR_Page.md`](../Pages/Patient-Portal/06_PHR_Page.md)  
