# พอร์ทัลผู้ป่วย — PDPA Page (Privacy & Consent Management)

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Patient-Portal/10_PDPA_Page.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Patient-Portal/10_PDPA_Page.md`](../Pages/Patient-Portal/10_PDPA_Page.md)  
