# พอร์ทัลผู้ป่วย — Map Page (Nearby Healthcare)

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Patient-Portal/09_Map_Page.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Patient-Portal/09_Map_Page.md`](../Pages/Patient-Portal/09_Map_Page.md)  
