# พอร์ทัลผู้ป่วย — Login Page

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Patient-Portal/01_Login_Page.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Patient-Portal/01_Login_Page.md`](../Pages/Patient-Portal/01_Login_Page.md)  
