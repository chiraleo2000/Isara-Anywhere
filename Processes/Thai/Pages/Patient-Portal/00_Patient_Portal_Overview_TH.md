# พอร์ทัลผู้ป่วย — Architecture & Navigation Overview

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Patient-Portal/00_Patient_Portal_Overview.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Patient-Portal/00_Patient_Portal_Overview.md`](../Pages/Patient-Portal/00_Patient_Portal_Overview.md)  
> **อัปเดต:** 9 กรกฎาคม 2569 · รัน `python scripts/sync-processes-thai.py` เพื่อสร้างใหม่

**เวอร์ชัน:** 3.2.0
**อัปเดตล่าสุด:** February 10, 2026
