# Meeting Server — Overview

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Meeting-Server/00_Meeting_Server_Overview.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Meeting-Server/00_Meeting_Server_Overview.md`](../Pages/Meeting-Server/00_Meeting_Server_Overview.md)  
> **อัปเดต:** 9 กรกฎาคม 2569 · รัน `python scripts/sync-processes-thai.py` เพื่อสร้างใหม่

**เวอร์ชัน:** v1.7.21 · **Updated:** 2026-05-23
