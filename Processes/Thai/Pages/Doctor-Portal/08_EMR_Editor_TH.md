# พอร์ทัลแพทย์ — EMR Editor (Electronic Medical Record)

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Doctor-Portal/08_EMR_Editor.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Doctor-Portal/08_EMR_Editor.md`](../Pages/Doctor-Portal/08_EMR_Editor.md)  
