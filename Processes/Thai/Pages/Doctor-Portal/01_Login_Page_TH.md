# พอร์ทัลแพทย์ — Login Page

> **เอกสารภาษาไทย** — สร้างอัตโนมัติจาก `Pages/Doctor-Portal/01_Login_Page.md`  
> **ต้นฉบับภาษาอังกฤษ:** [`Pages/Doctor-Portal/01_Login_Page.md`](../Pages/Doctor-Portal/01_Login_Page.md)  
